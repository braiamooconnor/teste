      ...
      >
        <Card className="shadow-2xl bg-slate-800 bg-opacity-70 backdrop-blur-md border-slate-700 text-slate-100">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full border-slate-600 text-slate-300 hover:bg-slate-700 hover:text-white" onClick={handleGoogleLogin} disabled={formDisabled}>
